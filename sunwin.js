// ============================================================
// PHẦN 1/5: IMPORTS + CONFIG + PATTERN DATABASE + ANALYZER
// ============================================================
...
// ============================================================
// DATASET ANALYZER - TỰ HỌC TỪ HISTORY (KHÔNG CẦN FILE)
// ============================================================
class PatternDatasetAnalyzer {
    ...
    /**
     * Nạp dataset từ history thực tế (thay vì đọc file).
     * Trích xuất các cửa sổ pattern có độ dài từ 4-16 và next result.
     */
    loadFromHistory(historyRecords) {
        ...
        // Trích xuất tất cả các cửa sổ độ dài 4-16 + next char
        ...
        console.log(`📚 Dataset tự học: ${this.totalSamples} mẫu cầu (độ dài ${this.minLen}-${this.maxLen})`);
...
// Khởi tạo dataset (sẽ được nạp từ history sau)
...
class LSTMLikeModel {
    ...
    trainOnHistory(historyRecords, epochs = 2) {
        // Tự trích xuất training samples từ history (không cần file)
        const samples = [];
...
// LSTM sẽ được khởi tạo động khi có đủ history
// Không cần file dataset
// ============================================================
...
class AdvancedDeepLearningAI {
    ...
    loadHistory(historyData) {
        ...
        if (this.history.length >= 30) {
            ...
            // BƯỚC 3: Fine-tune các thuật toán khác
